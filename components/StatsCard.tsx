...
const StatsCard = ({ headerTitle, total, lastMonthCount, currentMonthCount }: StatsCard) => {
    ...
    const isDrecement = trend === 'decrement';
  return (
    <article className="stats-card">
        ...
        <div className="content">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                    <figure className="flex items-center gap-1">
                        <img 
                            src={`/assets/icons/${isDrecement ? 'arrow-down-red.svg' : 'arrow-up-green.svg'}`} 
                            className="size-5"
                            alt="arrow"
                        />
                        <figcaption className={cn('text-sm font-medium', isDrecement ? 'text-red-500' : 'text-success-700')}>
            ...
            <img 
                src={`assets/icons/${isDrecement ? 'decrement.svg' : 'increment.svg'}`}
